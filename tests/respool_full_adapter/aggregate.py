...
def main() -> int:
    ...
    # Shards emit what they verified; the aggregate refuses to publish anything
    # else, and re-checks the identities against this checkout's history.
    try:
        provenance.check_emitted({
            "product_base": base, "verifier_import_commit": import_commit,
