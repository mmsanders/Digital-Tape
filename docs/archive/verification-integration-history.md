# Archived: per-round verification integration narrative

**Relocated by WO-1 (context diet), 20 September 2026 UTC.** This is
`docs/VERIFICATION-INTEGRATION.md` as it stood at main `d63b73d`, moved here verbatim
and unedited. Nothing was summarised away and no sentence was rewritten. The **only**
change is mechanical: 11 relative link targets were rebased by one prefix (`../`) so
every citation still resolves from this directory. Undo that prefix and this file is
byte-identical to the original, whose SHA-256 is
`19da9fa4213546958060ca81d8e2d385fd7379b08303f197751133aa7644defb`.

Every source publication, tree, blob and findings hash for P1-R1 through P1-R24 remains
readable below. The live integration boundary is
[docs/VERIFICATION-INTEGRATION.md](../VERIFICATION-INTEGRATION.md).
