...
| ID | Package | Owner | Stream | Status |
|---|---|---|---|---|
| WP-06 | Block device layer, superblock, index commit | Agent | 1 | 289/289 recorded mount assertions independently dispositioned; full package and uncovered #20 behavior remain held; P1-R1 assigns split planning, not engine merge |
| WP-07 | Chunk allocator, copy-on-write Side B | Agent | 1 | Two VT8 operation cases published, synthetic only; diagnostic import/adapter and verifier corrections P1-R1-V01–V03 assigned; no full acceptance |
