...
| WP-08 | Playback, seek, variable-rate scrub | Agent | 1 | Corrected verifier package `467a34bb...` independently enforces per-render service and rejects the old cadence. Software #83 owns exact test-first import and a fresh held trace; product acceptance and merge remain suspended |
...
| WP-11 | CLI harness and golden-file regression suite | Verification | 2 | Corrected verifier candidates remain byte-identical, synthetic, unlistened and unaccepted. Fresh product evidence is pending Software #83; golden CI remains red |
