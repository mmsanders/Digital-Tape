...
| WP-08 | Playback, seek, variable-rate scrub | Agent | 1 | Corrected three-family package is exactly imported in draft PR #60; no product run or acceptance. [The missing deterministic scrub table](WP-08.md) is now PM-issued; independent boundary/ramp/side-switch coverage remains required before implementation merge |
