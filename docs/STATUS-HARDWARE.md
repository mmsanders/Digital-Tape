...
| WP-05 | 64 GB cart withdrawn per Michael. **No cheap 4 GB V30 part found 12 Sep**: the only 4 GB microSD at the one reachable distributor is industrial SLC at $167.81 and carries no V30 marking | **PM disposition needed** on which population the six SKUs come from; Michael decides the capacity deviation. Options in `hardware/sourcing/2026-09-12-parts.md` |
