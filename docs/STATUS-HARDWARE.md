...
arrives. **Two items appended to `docs/FOR-MICHAEL.md`** (Q-005, Q-006), both with defaults.
...
**Q-006** — the library printer: machine, materials, session limits, and how the queue really
